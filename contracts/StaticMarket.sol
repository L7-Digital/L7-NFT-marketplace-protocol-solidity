...
contract StaticMarket {
		...
		returns (uint)
	{
		...
		require((tokenIdAndNumeratorDenominator[1] * call_amounts[1]) == (tokenIdAndNumeratorDenominator[2] * call_amounts[0]),"anyERC1155ForERC20: wrong ratio");
		...
		returns (uint)
	{
		...
		require((tokenIdAndNumeratorDenominator[1] * call_amounts[0]) == (tokenIdAndNumeratorDenominator[2] * call_amounts[1]),"anyERC20ForERC1155: wrong ratio");
		...
		returns (uint)
	{
		...
		require((numeratorDenominator[0] * call_amounts[0]) == (numeratorDenominator[1] * call_amounts[1]),"anyERC20ForERC20: wrong ratio");
